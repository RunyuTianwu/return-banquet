...
// 腾讯地图初始化
function initMap() {
    var center = new TMap.LatLng(32.92700997377291, 117.40339499405341);
...
function updateCountdown() {
    const weddingDate = new Date(2025, 7, 24, 11, 58, 0);
    const now = new Date();
    const diff = weddingDate - now;
    if (diff < 0) {
        if (document.getElementById('countdown-message')) {
            document.getElementById('countdown-message').textContent = "喜宴正在进行中！";
        }
